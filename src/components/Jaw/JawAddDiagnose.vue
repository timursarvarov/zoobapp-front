      ...
      <div class="md-toolbar-row">
        ...
        <div class="md-toolbar-section-end">
          ...
          >
            ...
            <md-tooltip
              v-if="'locations' in originalDiagnose"
              md-delay="1000"
            >
              Toggle teeth
            </md-tooltip>
    ...
    export default {
      ...
      methods: {
        ...
        shouldHideLocation(toothId, location) {
          ...
          if (!this.preferj) {
            return !this.getNestedProperty(this.originalDiagnose, 'view', location);
          }
        ...
        setLastLocationForAllTeeth() {
          if (!this.isEmpty(this.originalDiagnose.locations)) {
            ...
            if (this.selectableTeeth.length === this.numProps(this.diagnose.teeth)) {
        ...
        chooseLocation(toothId, location) {
          ...
          if (this.hasProp(this.originalDiagnose.locations, location)) {
            ...
            const { addLocation } = this.originalDiagnose;
            this.diagnose = addLocation(location, this.diagnose, this.originalDiagnose, toothId);
