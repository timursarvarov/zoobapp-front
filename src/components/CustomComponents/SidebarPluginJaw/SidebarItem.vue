<template>
    <component :is="baseComponent" :to="link.path ? link.path : '/'" :class="{ active: isActive(link.path) }" tag="li">
        <a v-if="isMenu" class="nav-link sidebar-menu-item" :aria-expanded="!collapsed" data-toggle="collapse" @click.prevent="collapseMenu">
    ...
    methods: {
        ...
        isActive(re) {
            if (this.$route && this.$route.path) {
                ...
                } else if (re && this.$route.path.split('/').length !== re.split('/').length) {
