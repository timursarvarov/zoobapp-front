        ...
        <a class="md-list-item-router md-list-item-container md-button-clean dropdown">
            <div class="md-list-item-content">
                <drop-down direction="down">
                    <md-button slot="title" class="md-simple dropdown-togglec md-just-icon md-list-item-content" data-toggle="dropdown">
                        <md-icon>
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        >
                            <a :style="{ color: $i18n.locale === lang ? '#fff!important' : '' }">
                                <img style="margin-right:10px" :src="require(`@/assets/images/flags/${lang}.png`)" />
