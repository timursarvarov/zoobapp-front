    ...
    <div class="md-layout">
      <div class="md-layout-item md-size-50 mx-auto text-center">
        ...
        <h5 class="description">
          You have Free Unlimited Updates and Premium Support on each package.</h5>
      </div>
    </div>
    <div class="md-layout">
      ...
      <div class="md-layout-item md-medium-size-25 md-small-size-50 md-xsmall-size-100 md-size-25">
        ...
        >
          ...
          <p
            slot="description"
            class="card-description"
          >This is good if your company size is between 11 and 99 Persons.</p>
          <md-button
            slot="footer"
            class="md-white md-round"
          >Choose Plan</md-button>
      ...
      <div class="md-layout-item md-medium-size-25 md-small-size-50 md-xsmall-size-100 md-size-25">
        ...
        >
          ...
          <p
            slot="description"
            class="card-description"
          >This is good if your company size is between 99+ Persons.</p>
          <md-button
            slot="footer"
            class="md-white md-round"
          >Choose Plan</md-button>
