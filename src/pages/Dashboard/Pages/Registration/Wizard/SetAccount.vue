       ...
       <md-field
          ...
          >
           ...
           <slide-y-down-transition>
              <md-button v-show="errors.has('username')"
          ...
          >
           ...
           <slide-y-down-transition>
              <md-button v-show="errors.has('firstName')"
          ...
          >
            ...
            <slide-y-down-transition>
              <md-button v-show="errors.has('lastName')"
      ...
      <div class="md-layout-item md-size-50 md-small-size-100">
        ...
        <md-field
          ...
          >
            ...
            <slide-y-down-transition>
              <md-button v-show="errors.has('password')"
          ...
          >
            ...
            <slide-y-down-transition>
              <md-button v-show="errors.has('rPassword')"
