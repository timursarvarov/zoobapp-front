<template>
  <div class="md-layout wizard-registration-form">
    <div class="md-layout-item md-size-66 md-xsmall-size-80 md-small-size-80 mx-auto">
      <simple-wizard>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      setClinicName() {
        return new Promise((resolve, reject) => {
          this.$store.dispatch(CLINIC_UPDATE, {
            clinic: {
