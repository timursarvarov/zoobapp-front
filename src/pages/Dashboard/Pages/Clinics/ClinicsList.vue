<template>
    <div class="md-layout clinics-list-wrapper">
            ...
            <md-card>
                    ...
                    <div class="md-layout-item md-layout md-gutter md-alignment-bottom-right">
                        ...
                        >
                            <md-button
                                ...
                                @click="showAddClinicForm=!showAddClinicForm"
                            >
                                <md-icon>add</md-icon>
                            </md-button>
                ...
                Try a different search term or create a new user.`"
                                ...
                                <div v-else-if="(typeof item[field.key]) === 'object'">
                                    ...
                                    >
                                        ...
                                        >
                                            <t-avatar
                                                :small="true"
                                                :text-to-color="item[field.key].ID"
                    ...
                    <t-table-editor
                        ...
                        :show-forml.sync="showForm"
                        @selected="setColumns"
                    />
                    <clinic-add-form :show-form.sync="showAddClinicForm" />
                </md-card-content>
                <md-card-actions md-alignment="space-between">
                    <div class>
                        <p
                            class="card-category"
                        >
                            Showing {{ from + 1 }} to {{ to }} of {{ totalPages }} entries
                        </p>
                    </div>
                    <pagination
