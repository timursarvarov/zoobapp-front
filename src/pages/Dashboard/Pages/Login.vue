      ...
      <login-card header-color="green">
        ...
        <p slot="description" class="description">Or Be Classical</p>
          ...
          {'md-error': errors.has('username')}]">
            ...
            type="username"
            required
            v-validate="modelValidations.username" ></md-input>
...
<script>
  ...
  import { AUTH_REQUEST } from '@/store/modules/constants';
  ...
  export default {
    ...
    methods: {
      ...
      login() {
        ...
        if (
          this.errors.has('password') || !this.password
        ) {
          this.showErrorsValidate('password');
          return;
        }
        if (
          this.errors.has('username') || !this.username
        ) {
