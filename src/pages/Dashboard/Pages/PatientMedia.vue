    ...
    <div class="md-layout">
      <div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-33">
        <product-card header-animation="true">
          ...
          >
            ...
            Beach and bus stop just 2 min by walk
            and near to "Naviglio" where you can
      ...
      <div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-33">
        <product-card header-animation="true">
          ...
          >
            The place is close to Metro Station
            and bus stop just 2 min by walk
            and near to "Naviglio" where you can
      ...
      <div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-33">
        <product-card header-animation="true">
          ...
          >
            ...
            Beach and bus stop just
            2 min by walk and near
            to "Naviglio" where you can enjoy
      ...
      <div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-33">
        <product-card header-animation="true">
          ...
          <div
            ...
            class="card-description"
          >
            The place is close to Metro
            Station and bus stop just 2 min by walk and near
            to "Naviglio" where you can enjoy
      ...
      <div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-33">
        <product-card header-animation="true">
          ...
          <div
            ...
            class="card-description"
          >
            The place is close to Metro Station and bus stop just
