<template>
  <div  :style="[{'min-width': `${size.width}px`},
    ...
    <h5 class="info-text">
      Write a diagnose description, or choose from templates.
    </h5>
    <div class="md-layout">
...
import { SlideYDownTransition } from 'vue2-transitions';
  export default {
    ...
    methods: {
      ...
      setDescription(key){
        const desc = Object.values(this.descriptions).find((d)=>{ 
          return d.title === key
          })
    ...
    computed:{
      descriptionHeaders:{
        get(){
          const descriptionTitles = Object.values(this.descriptions).map((d) => { return d.title })
