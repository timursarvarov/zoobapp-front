            ...
            >
                <router-view
                    v-if="
                        $route &&
                            $route.params &&
                            $route.params.planID in patient.plans
                    "
                    :id="key"
                    :current-plan="plan"
                />
                <md-empty-state
                    ...
                    :md-description="
                        `No pla with ID ${$route.params.planID} found. Scroll top, and create new one.`
                    "
                >
                    <md-button
...
export default {
    ...
    methods: {
        ...
        onChangeTab(plan) {
            if (
                this.patient.currentPlan &&
                this.patient.currentPlan.ID !== plan.ID
            ) {
                this.$store.dispatch(PATIENT_PLAN_SWITCH_CURRENT, {
                    planID: pln.ID
                });
