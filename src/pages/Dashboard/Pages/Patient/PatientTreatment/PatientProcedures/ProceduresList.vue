...
<script>
    import { PATIENT_TREATMETS_UPDATE, TEETH_DEFAULT_LOCATIONS } from '@/constants';
    ...
    export default {
        ...
        computed: {
            ...
            setecltedTeeth() {
                if (!this.isEmpty(this.selectedProcedure)) {
                    return Object.keys(this.selectedProcedure.teeth);
                }
                return [];
            },
            tableData() {
