<template>
  <div ref="parent">
    <jaw-add-treatment
      ...
      v-model="newTreatmentParamsLocal"
...
<script>
    import { JawAddTreatment } from '@/components';
    ...
    export default {
      ...
      props: {
        error: {
          type: Object,
          default: () => ({
            message: 'Choose tooth or treatment location',
            type: 'locations',
            show: 'false',
          }),
        },
      ...
      methods: {
        ...
        isValidLoctions() {
          ...
          return !this.isEmpty(this.treatmentLocal.teeth);
        },
      },
      computed: {
        newTreatmentParamsLocal: {
          get() {
