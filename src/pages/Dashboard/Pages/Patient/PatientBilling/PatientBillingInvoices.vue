...
<template>
    <div class="items-list-wrapper">
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div
                        v-else-if="field.key === 'procedures' && item.procedures"
                        :class="field.key"
                    >
                        {{ item.procedures.length }}
                    </div>
                    <div
                        v-else-if="field.key === 'payments' && item.payments"
                        :class="field.key"
                    >
                        {{ item.payments.length }}
                    </div>
                    <div
                        v-else-if="field.key === 'round'"
                        :class="field.key"
                    >
                        {{ item.round }}
                    </div>
                    <div
                        v-else-if="field.key === 'discount'"
                        :class="field.key"
                    >
                        {{ item.discount || 0 }}%
                        <br>
        ...
        <t-table-editor
            ...
            :available-table-columns="computedAvailableBillingTableColumns"
