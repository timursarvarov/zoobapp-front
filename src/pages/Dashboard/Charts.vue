    ...
    <div>
        <div class="header text-center">
            ...
            <p class="category">
                ...
                >Chartist.js</a>. Please check out their
                <a
                    ...
                    <template slot="footer">
                        <div class="md-layout">
                            ...
                            <div class="md-layout-item">
                                <i class="fa fa-circle text-info" /> Apple
                                <i class="fa fa-circle text-warning" /> Samsung
                                <i class="fa fa-circle text-danger" /> Windows Phone
                            </div>
                        </div>
                    </template>
                </chart-card>
