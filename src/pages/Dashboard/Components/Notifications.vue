                ...
                <md-card>
                    ...
                    <md-card-content>
                        ...
                        <div class="alert alert-rose alert-with-icon" data-notify="container">
                            ...
                            <i data-notify="icon" class="material-icons">add_alert</i>
                            <span data-notify="message"
                                >This is a notification with close button and icon and is made with ".alert-rose". You can see that the icon and the
                                close button are always vertically aligned. This is a beautiful notification. So you don't have to worry about the
                                style.</span
                            >
                        </div>
                    </md-card-content>
                ...
                <md-card>
                    ...
                    <md-card-content>
                        <div class="places-buttons text-center">
                            ...
                            <md-button class="md-success" @click="notifyVue('bottom', 'center')">
                                Bottom Center
                            </md-button>
                            <md-button class="md-success" @click="notifyVue('bottom', 'right')">
                                Bottom Right
                            </md-button>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <md-button class="md-primary md-round classic-modal" @click="classicModal = true">
                                Classic Modal
                            </md-button>
                            ...
                            <md-button class="md-info md-round notice-modal" @click="noticeModal = true">
                                Notice Modal
                            </md-button>
                                        ...
                                        <div class="md-layout">
                                            <div class="md-layout-item md-size-66">
                                                ...
                                                <p class="description">
                                                    ...
                                                    <a href="https://www.creative-tim.com/">Creative Tim</a>. You can choose a social network or go
                                                    for the classic version, whatever works best for you.
                                                </p>
                                            </div>
                            ...
                            <md-button class="md-rose md-round small-alert-modal" @click="smallAlertModal = true">
                                Small Alert Modal
                            </md-button>
