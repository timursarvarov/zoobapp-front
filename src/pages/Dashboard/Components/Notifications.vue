                    ...
                    <md-card-content>
                        ...
                        >
                            ...
                            <span data-notify="message">This is a notification
                                with close button and icon and have many lines.
                                You can see that the icon and the close button
                        ...
                        >
                            ...
                            >add_alert</i>
                            <span data-notify="message">This is a notification
                                with close button and icon and is made with ".alert-rose".
                                You can see that the icon and the close button
                                are always vertically aligned.
                                This is a beautiful notification. So you don't
                                have to worry about the style.</span>
                ...
                <md-card>
                    ...
                    <md-card-content>
                        ...
                        <div class="alert alert-rose">
                            ...
                            <span><b> Rose - </b> This is a regular notification
                                made with ".alert-rose"</span>
                        </div>
                    </md-card-content>
                </md-card>
            </div>
                            ...
                            >
                                ...
                                <template slot="body">
                                    <div class="instruction">
                                        <div class="md-layout">
                                            <div class="md-layout-item md-size-66">
                                                ...
                                                <p class="description">
                                                    The first step is to create an account at <a href="https://www.creative-tim.com/">Creative Tim</a>. You can choose a social network or go for the classic version, whatever works best for you.
                                                </p>
                                            </div>
                                    ...
                                    <p>
                                        ...
                                        contact us or send us a tweet @creativetim.
                                        We're here to help!
                                    </p>
                                </template>
