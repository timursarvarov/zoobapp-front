  ...
  <div class="md-layout">
    <div class="md-layout-item md-size-50 md-medium-size-100">
      <tabs
        ...
        <h4 class="title" slot="header-title">Navigation Pills - <small class="description">Horizontal Tabs</small></h4>
    ...
    <div class="md-layout-item md-size-50 md-medium-size-100">
      <tabs
        ...
        <h4 class="title" slot="header-title">Navigation Pills - <small class="description">Vertical Tabs</small></h4>
    ...
    <div class="md-layout-item md-size-50 md-medium-size-100">
      <tabs
        ...
        nav-pills-icons
        color-button="success">
        <h4 class="title" slot="header-title">Navigation Pills Icons - <small class="description">Vertical Tabs</small></h4>
    ...
    <div class="md-layout-item md-size-66 mx-auto md-medium-size-100">
      <tabs
        ...
        plain
        color-button="warning">
        <h3 class="title text-center" slot="header-title">Page Subcategories</h3>
