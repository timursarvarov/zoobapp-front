    ...
    <div class="md-layout-item md-size-50 md-medium-size-100">
      ...
      >
        <h4
          class="title"
          slot="header-title"
        >Navigation Pills - <small class="description">Vertical Tabs</small></h4>
    ...
    <div class="md-layout-item md-size-50 md-medium-size-100">
      ...
      >
        <h4
          class="title"
          slot="header-title"
        >Navigation Pills Icons - <small class="description">Vertical Tabs</small></h4>
