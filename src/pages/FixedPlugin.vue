        ...
        <div class="dropdown show-dropdown" :class="{ show: isOpen }">
            ...
            <ul class="dropdown-menu" :class="{ show: isOpen }">
                ...
                <li class="adjustments-line sidebar-mini">
                    Sidebar Mini
                    <md-switch :value="!sidebarMini" @change="val => updateValue('sidebarMini', val)" />
                </li>
                <li class="adjustments-line sidebar-img">
                    Sidebar Image
                    <md-switch :value="!sidebarImg" @change="val => updateValueImg('sidebarImg', val)" />
                </li>
                ...
                <li class="button-container">
                    <div class="">
                        <md-button class="md-success md-block" :href="proUrl" target="_blank">
                            Buy Now
                        </md-button>
                    </div>
                </li>
                ...
                <li class="button-container">
                    <div class="">
                        <md-button class="md-default md-block" :href="documentationLink" target="_blank">
                            Documentation
                        </md-button>
                    </div>
                </li>
...
export default {
    ...
    data() {
        return {
            ...
            sidebarBg: [{ colorBg: 'black', active: true }, { colorBg: 'white', active: false }, { colorBg: 'red', active: false }],
            sidebarImages: [
